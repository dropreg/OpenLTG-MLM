...
def merge_writingprompt():
    ...
    # root_dir = "/opt/data/private/data/arr1015_data/roc_story/processed/"
    root_dir = "/opt/data/private/data/arr1015_data/roc_story/seg_two/processed/"
    # Train File:
    train_source_file = "train.split.source"
    train_target_file = "train.split.target"
    # Dev File:
    dev_source_file = "val.split.source"
    dev_target_file = "val.split.target"
    # Test File:
