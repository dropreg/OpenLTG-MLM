...
from .open_gen_dataset import LanguagePairDataset
...
class TranslationConfig(FairseqDataclass):
    ...
    span_sampling: bool = field(
        default=False, metadata={"help": "use sampling strategy to generate sample"}
    )


@register_task("open_generation", dataclass=TranslationConfig)
class OpenTranslationTask(FairseqTask):
    ...
    def __init__(self, cfg: TranslationConfig, src_dict, tgt_dict):
        ...
        self.span_sampling = cfg.span_sampling
