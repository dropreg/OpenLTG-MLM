...
@register_criterion("plan_loss")
class PlanLabelSmoothedCrossEntropyCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        output, length_out, length_tgt = model(**net_input)
        
        target = sample["target"]
        mask = sample["net_input"]["tgt_segment"].ne(target)
